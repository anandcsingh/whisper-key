...
export class FlagrantCredentialEntity extends Struct({
    id: Field,
    ...
    static fromPlainObject(obj) {
        return new FlagrantCredentialEntity({
            id: Field(obj.id),
...
export class FlagrantCredentialContract extends SmartContract {
    constructor() {
        super(...arguments);
        this.mapRoot = State();
    }
...
], FlagrantCredentialContract.prototype, "mapRoot", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field]),
    __metadata("design:returntype", void 0)
], FlagrantCredentialContract.prototype, "setMapRoot", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [PublicKey,
        FlagrantCredentialEntity,
        MerkleMapWitness,
        Field]),
    __metadata("design:returntype", void 0)
], FlagrantCredentialContract.prototype, "issueCredential", null);
export class CredentialProxy {
    constructor(contractAddress, credentialName, owner, proofsEnabled) {
        ...
        this.contractType = FlagrantCredentialContract;
        ...
        this.zkApp = new FlagrantCredentialContract(this.contractAddress);
    }
    ...
    async issueCredential(owner, credential, merkleStore) {
        if (!this.useLocal)
            await fetchAccount({ publicKey: this.contractAddress });
        const entity = FlagrantCredentialEntity.fromPlainObject(credential);
