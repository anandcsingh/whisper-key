...
export class rishatestEntity extends Struct({
    id: Field,
    ...
    toPlainObject() {
        return {
            ...
            Age: Number(this.Age.toBigInt()),
        };
    }
    static fromPlainObject(obj) {
        return new rishatestEntity({
            id: Field(obj.id),
    ...
    hash() {
        return Poseidon.hash(this.id.toFields()
            ...
            .concat(this.Name.toFields())
                        .concat(this.Age.toFields())
            );
    }
}
export class rishatestContract extends SmartContract {
    constructor() {
        super(...arguments);
        this.mapRoot = State();
        this.events = {
...
], rishatestContract.prototype, "mapRoot", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field]),
    __metadata("design:returntype", void 0)
], rishatestContract.prototype, "setMapRoot", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [PublicKey,
        ...
        Field]),
    __metadata("design:returntype", void 0)
], rishatestContract.prototype, "issueCredential", null);
export class CredentialProxy {
    constructor(contractAddress, credentialName, owner, proofsEnabled) {
        ...
        this.contractType = rishatestContract;
        ...
        this.zkApp = new rishatestContract(this.contractAddress);
    }
    ...
    async getEntityFromObject(obj) {
        return rishatestEntity.fromPlainObject(obj);
    }
    ...
    async issueCredential(payer, credential, merkleStore) {
        ...
        const entity = rishatestEntity.fromPlainObject(credential);
