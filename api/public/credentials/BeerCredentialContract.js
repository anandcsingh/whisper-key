...
export class BeerCredentialEntity extends Struct({
    id: Field,
    ...
    static fromPlainObject(obj) {
        return new BeerCredentialEntity({
            id: Field(obj.id),
...
export class BeerCredentialContract extends SmartContract {
    constructor() {
        super(...arguments);
        this.mapRoot = State();
    }
...
], BeerCredentialContract.prototype, "mapRoot", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field]),
    __metadata("design:returntype", void 0)
], BeerCredentialContract.prototype, "setMapRoot", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [PublicKey,
        BeerCredentialEntity,
        MerkleMapWitness,
        Field]),
    __metadata("design:returntype", void 0)
], BeerCredentialContract.prototype, "issueCredential", null);
export class CredentialProxy {
    constructor(contractAddress, credentialName, owner, proofsEnabled) {
        ...
        this.contractType = BeerCredentialContract;
        ...
        this.zkApp = new BeerCredentialContract(this.contractAddress);
    }
    ...
    async issueCredential(owner, credential, merkleStore) {
        if (!this.useLocal)
            await fetchAccount({ publicKey: this.contractAddress });
        const entity = BeerCredentialEntity.fromPlainObject(credential);
