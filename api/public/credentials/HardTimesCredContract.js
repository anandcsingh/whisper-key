...
export class HardTimesCredEntity extends Struct({
    id: Field,
    ...
    static fromPlainObject(obj) {
        return new HardTimesCredEntity({
            id: Field(obj.id),
...
export class HardTimesCredContract extends SmartContract {
    constructor() {
        super(...arguments);
        this.mapRoot = State();
    }
...
], HardTimesCredContract.prototype, "mapRoot", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field]),
    __metadata("design:returntype", void 0)
], HardTimesCredContract.prototype, "setMapRoot", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [PublicKey,
        ...
        Field]),
    __metadata("design:returntype", void 0)
], HardTimesCredContract.prototype, "issueCredential", null);
export class CredentialProxy {
    constructor(contractAddress, credentialName, owner, proofsEnabled) {
        ...
        this.contractType = HardTimesCredContract;
        ...
        this.zkApp = new HardTimesCredContract(this.contractAddress);
    }
    ...
    async issueCredential(owner, credential, merkleStore) {
        if (!this.useLocal)
            await fetchAccount({ publicKey: this.contractAddress });
        const entity = HardTimesCredEntity.fromPlainObject(credential);
