...
export class PictureFrameEntity extends Struct({
    id: Field,
    ...
    static fromPlainObject(obj) {
        return new PictureFrameEntity({
            ...
            Url: CircuitString.fromString(obj.Url),
        });
    }
    hash() {
        return Poseidon.hash(this.id.toFields()
            ...
            .concat(this.Name.toFields())
                        .concat(this.Url.toFields())
            );
    }
}
export class PictureFrameContract extends SmartContract {
    constructor() {
        super(...arguments);
        this.mapRoot = State();
        this.events = {
...
], PictureFrameContract.prototype, "mapRoot", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field]),
    __metadata("design:returntype", void 0)
], PictureFrameContract.prototype, "setMapRoot", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [PublicKey,
        ...
        Field]),
    __metadata("design:returntype", void 0)
], PictureFrameContract.prototype, "issueCredential", null);
export class CredentialProxy {
    constructor(contractAddress, credentialName, owner, proofsEnabled) {
        ...
        this.contractType = PictureFrameContract;
        ...
        this.zkApp = new PictureFrameContract(this.contractAddress);
    }
    ...
    async getEntityFromObject(obj) {
        return PictureFrameEntity.fromPlainObject(obj);
    }
    ...
    async issueCredential(payer, credential, merkleStore) {
        ...
        const entity = PictureFrameEntity.fromPlainObject(credential);
