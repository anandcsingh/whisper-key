...
export class HardestCredentialEntity extends Struct({
    id: Field,
    ...
    static fromPlainObject(obj) {
        return new HardestCredentialEntity({
            id: Field(obj.id),
...
export class HardestCredentialContract extends SmartContract {
    constructor() {
        super(...arguments);
        this.mapRoot = State();
    }
...
], HardestCredentialContract.prototype, "mapRoot", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field]),
    __metadata("design:returntype", void 0)
], HardestCredentialContract.prototype, "setMapRoot", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [PublicKey,
        HardestCredentialEntity,
        MerkleMapWitness,
        Field]),
    __metadata("design:returntype", void 0)
], HardestCredentialContract.prototype, "issueCredential", null);
export class CredentialProxy {
    constructor(contractAddress, credentialName, owner, proofsEnabled) {
        ...
        this.contractType = HardestCredentialContract;
        ...
        this.zkApp = new HardestCredentialContract(this.contractAddress);
    }
    ...
    async issueCredential(owner, credential, merkleStore) {
        if (!this.useLocal)
            await fetchAccount({ publicKey: this.contractAddress });
        const entity = HardestCredentialEntity.fromPlainObject(credential);
