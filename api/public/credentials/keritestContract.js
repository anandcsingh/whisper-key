...
export class keritestEntity extends Struct({
    id: Field,
...
export class keritestContract extends SmartContract {
    constructor() {
        super(...arguments);
        this.mapRoot = State();
    }
...
], keritestContract.prototype, "mapRoot", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field]),
    __metadata("design:returntype", void 0)
], keritestContract.prototype, "setMapRoot", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [PublicKey,
        ...
        Field]),
    __metadata("design:returntype", void 0)
], keritestContract.prototype, "issueCredential", null);
export class CredentialProxy {
    constructor(contractAddress, credentialName, owner, proofsEnabled) {
        ...
        this.contractType = keritestContract;
        ...
        this.zkApp = new keritestContract(this.contractAddress);
    }
    ...
    async issueCredential(payer, credential, merkleStore) {
        ...
        const entity = keritestEntity.fromPlainObject(credential);
