...
export class FutureEntity extends Struct({
    id: Field,
...
export class FutureContract extends SmartContract {
    constructor() {
        super(...arguments);
        this.mapRoot = State();
    }
...
], FutureContract.prototype, "mapRoot", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field]),
    __metadata("design:returntype", void 0)
], FutureContract.prototype, "setMapRoot", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [PublicKey,
        ...
        Field]),
    __metadata("design:returntype", void 0)
], FutureContract.prototype, "issueCredential", null);
export class CredentialProxy {
    constructor(contractAddress, credentialName, owner, proofsEnabled) {
        ...
        this.contractType = FutureContract;
        ...
        this.zkApp = new FutureContract(this.contractAddress);
    }
    ...
    async issueCredential(payer, credential, merkleStore) {
        ...
        const entity = FutureEntity.fromPlainObject(credential);
