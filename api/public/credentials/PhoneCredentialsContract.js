...
export class PhoneCredentialsEntity extends Struct({
    id: Field,
    ...
    static fromPlainObject(obj) {
        return new PhoneCredentialsEntity({
            id: Field(obj.id),
...
export class PhoneCredentialsContract extends SmartContract {
    constructor() {
        super(...arguments);
        this.mapRoot = State();
    }
...
], PhoneCredentialsContract.prototype, "mapRoot", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field]),
    __metadata("design:returntype", void 0)
], PhoneCredentialsContract.prototype, "setMapRoot", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [PublicKey,
        PhoneCredentialsEntity,
        MerkleMapWitness,
        Field]),
    __metadata("design:returntype", void 0)
], PhoneCredentialsContract.prototype, "issueCredential", null);
export class CredentialProxy {
    constructor(contractAddress, credentialName, owner, proofsEnabled) {
        ...
        this.contractType = PhoneCredentialsContract;
        ...
        this.zkApp = new PhoneCredentialsContract(this.contractAddress);
    }
    ...
    async issueCredential(owner, credential, merkleStore) {
        if (!this.useLocal)
            await fetchAccount({ publicKey: this.contractAddress });
        const entity = PhoneCredentialsEntity.fromPlainObject(credential);
