...
export class test1234ksEntity extends Struct({
    id: Field,
...
export class test1234ksContract extends SmartContract {
    constructor() {
        super(...arguments);
        this.mapRoot = State();
        this.events = {
...
], test1234ksContract.prototype, "mapRoot", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field]),
    __metadata("design:returntype", void 0)
], test1234ksContract.prototype, "setMapRoot", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [PublicKey,
        ...
        Field]),
    __metadata("design:returntype", void 0)
], test1234ksContract.prototype, "issueCredential", null);
export class CredentialProxy {
    constructor(contractAddress, credentialName, owner, proofsEnabled) {
        ...
        this.contractType = test1234ksContract;
        ...
        this.zkApp = new test1234ksContract(this.contractAddress);
    }
    ...
    async getEntityFromObject(obj) {
        return test1234ksEntity.fromPlainObject(obj);
    }
    ...
    async issueCredential(payer, credential, merkleStore) {
        ...
        const entity = test1234ksEntity.fromPlainObject(credential);
