...
export class LicenseCredentialsEntity extends Struct({
    id: Field,
    ...
    static fromPlainObject(obj) {
        return new LicenseCredentialsEntity({
            id: Field(obj.id),
...
export class LicenseCredentialsContract extends SmartContract {
    constructor() {
        super(...arguments);
        this.mapRoot = State();
    }
...
], LicenseCredentialsContract.prototype, "mapRoot", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field]),
    __metadata("design:returntype", void 0)
], LicenseCredentialsContract.prototype, "setMapRoot", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [PublicKey,
        LicenseCredentialsEntity,
        MerkleMapWitness,
        Field]),
    __metadata("design:returntype", void 0)
], LicenseCredentialsContract.prototype, "issueCredential", null);
export class CredentialProxy {
    constructor(contractAddress, credentialName, owner, proofsEnabled) {
        ...
        this.contractType = LicenseCredentialsContract;
        ...
        this.zkApp = new LicenseCredentialsContract(this.contractAddress);
    }
    ...
    async issueCredential(owner, credential, merkleStore) {
        if (!this.useLocal)
            await fetchAccount({ publicKey: this.contractAddress });
        const entity = LicenseCredentialsEntity.fromPlainObject(credential);
