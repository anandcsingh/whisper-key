...
export class DirectorEntity extends Struct({
    id: Field,
    ...
    toPlainObject() {
        return {
            ...
            Years: Number(this.Years.toBigInt()),
        };
    }
    ...
    hash() {
        return Poseidon.hash(this.id.toFields()
            ...
            .concat(this.Name.toFields())
                        .concat(this.Years.toFields())
            );
    }
}
export class DirectorContract extends SmartContract {
    constructor() {
        super(...arguments);
        this.mapRoot = State();
        this.events = {
...
], DirectorContract.prototype, "mapRoot", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field]),
    __metadata("design:returntype", void 0)
], DirectorContract.prototype, "setMapRoot", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [PublicKey,
        ...
        Field]),
    __metadata("design:returntype", void 0)
], DirectorContract.prototype, "issueCredential", null);
export class CredentialProxy {
    constructor(contractAddress, credentialName, owner, proofsEnabled) {
        ...
        this.contractType = DirectorContract;
        ...
        this.zkApp = new DirectorContract(this.contractAddress);
    }
    ...
    async getEntityFromObject(obj) {
        return DirectorEntity.fromPlainObject(obj);
    }
    ...
    async issueCredential(payer, credential, merkleStore) {
        ...
        const entity = DirectorEntity.fromPlainObject(credential);
