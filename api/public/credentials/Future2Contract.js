...
export class Future2Entity extends Struct({
    id: Field,
    ...
    toPlainObject() {
        return {
            ...
            a: Number(this.a.toBigInt()),
            b: this.b.toString(),
            c: this.c.toBase58(),
        };
    }
    static fromPlainObject(obj) {
        return new Future2Entity({
            id: Field(obj.id),
            ...
            a: Field(obj.a),
            b: CircuitString.fromString(obj.b),
            c: PublicKey.fromBase58(obj.c),
        });
    }
    hash() {
        return Poseidon.hash(this.id.toFields()
            ...
            .concat(this.a.toFields())
            .concat(this.b.toFields())
            .concat(this.c.toFields())
            );
    }
}
export class Future2Contract extends SmartContract {
    constructor() {
        super(...arguments);
        this.mapRoot = State();
    }
...
], Future2Contract.prototype, "mapRoot", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field]),
    __metadata("design:returntype", void 0)
], Future2Contract.prototype, "setMapRoot", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [PublicKey,
        ...
        Field]),
    __metadata("design:returntype", void 0)
], Future2Contract.prototype, "issueCredential", null);
export class CredentialProxy {
    constructor(contractAddress, credentialName, owner, proofsEnabled) {
        ...
        this.contractType = Future2Contract;
        ...
        this.zkApp = new Future2Contract(this.contractAddress);
    }
    ...
    async issueCredential(owner, credential, merkleStore) {
        ...
        const entity = Future2Entity.fromPlainObject(credential);
