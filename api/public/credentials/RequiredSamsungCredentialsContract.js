...
export class RequiredSamsungCredentialsEntity extends Struct({
    id: Field,
    ...
    static fromPlainObject(obj) {
        return new RequiredSamsungCredentialsEntity({
            id: Field(obj.id),
...
export class RequiredSamsungCredentialsContract extends SmartContract {
    constructor() {
        super(...arguments);
        this.mapRoot = State();
    }
...
], RequiredSamsungCredentialsContract.prototype, "mapRoot", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field]),
    __metadata("design:returntype", void 0)
], RequiredSamsungCredentialsContract.prototype, "setMapRoot", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [PublicKey,
        RequiredSamsungCredentialsEntity,
        MerkleMapWitness,
        Field]),
    __metadata("design:returntype", void 0)
], RequiredSamsungCredentialsContract.prototype, "issueCredential", null);
export class CredentialProxy {
    constructor(contractAddress, credentialName, owner, proofsEnabled) {
        ...
        this.contractType = RequiredSamsungCredentialsContract;
        ...
        this.zkApp = new RequiredSamsungCredentialsContract(this.contractAddress);
    }
    ...
    async issueCredential(owner, credential, merkleStore) {
        if (!this.useLocal)
            await fetchAccount({ publicKey: this.contractAddress });
        const entity = RequiredSamsungCredentialsEntity.fromPlainObject(credential);
