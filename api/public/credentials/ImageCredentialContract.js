...
export class ImageCredentialEntity extends Struct({
    id: Field,
    ...
    static fromPlainObject(obj) {
        return new ImageCredentialEntity({
            id: Field(obj.id),
            ...
            file: CircuitString.fromString(obj.file),
            path: CircuitString.fromString(obj.path),
            type: CircuitString.fromString(obj.type),
        });
    }
    hash() {
        return Poseidon.hash(this.id.toFields()
            ...
            .concat(this.file.toFields())
            .concat(this.path.toFields())
            .concat(this.type.toFields())
            );
    }
}
export class ImageCredentialContract extends SmartContract {
    constructor() {
        super(...arguments);
        this.mapRoot = State();
    }
...
], ImageCredentialContract.prototype, "mapRoot", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field]),
    __metadata("design:returntype", void 0)
], ImageCredentialContract.prototype, "setMapRoot", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [PublicKey,
        ImageCredentialEntity,
        MerkleMapWitness,
        Field]),
    __metadata("design:returntype", void 0)
], ImageCredentialContract.prototype, "issueCredential", null);
export class CredentialProxy {
    constructor(contractAddress, credentialName, owner, proofsEnabled) {
        ...
        this.contractType = ImageCredentialContract;
        ...
        this.zkApp = new ImageCredentialContract(this.contractAddress);
    }
    ...
    async issueCredential(owner, credential, merkleStore) {
        if (!this.useLocal)
            await fetchAccount({ publicKey: this.contractAddress });
        const entity = ImageCredentialEntity.fromPlainObject(credential);
