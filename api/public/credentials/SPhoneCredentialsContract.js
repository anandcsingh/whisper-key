...
export class SPhoneCredentialsEntity extends Struct({
    id: Field,
    ...
    static fromPlainObject(obj) {
        return new SPhoneCredentialsEntity({
            id: Field(obj.id),
...
export class SPhoneCredentialsContract extends SmartContract {
    constructor() {
        super(...arguments);
        this.mapRoot = State();
    }
...
], SPhoneCredentialsContract.prototype, "mapRoot", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field]),
    __metadata("design:returntype", void 0)
], SPhoneCredentialsContract.prototype, "setMapRoot", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [PublicKey,
        SPhoneCredentialsEntity,
        MerkleMapWitness,
        Field]),
    __metadata("design:returntype", void 0)
], SPhoneCredentialsContract.prototype, "issueCredential", null);
export class CredentialProxy {
    constructor(contractAddress, credentialName, owner, proofsEnabled) {
        ...
        this.contractType = SPhoneCredentialsContract;
        ...
        this.zkApp = new SPhoneCredentialsContract(this.contractAddress);
    }
    ...
    async issueCredential(owner, credential, merkleStore) {
        if (!this.useLocal)
            await fetchAccount({ publicKey: this.contractAddress });
        const entity = SPhoneCredentialsEntity.fromPlainObject(credential);
