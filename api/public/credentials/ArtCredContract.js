...
export class ArtCredEntity extends Struct({
    id: Field,
    ...
    toPlainObject() {
        return {
            ...
            XP: Number(this.XP.toBigInt()),
        };
    }
    static fromPlainObject(obj) {
        return new ArtCredEntity({
            id: Field(obj.id),
    ...
    hash() {
        return Poseidon.hash(this.id.toFields()
            ...
            .concat(this.XP.toFields())
            );
    }
}
export class ArtCredContract extends SmartContract {
    constructor() {
        super(...arguments);
        this.mapRoot = State();
        this.events = {
...
], ArtCredContract.prototype, "mapRoot", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field]),
    __metadata("design:returntype", void 0)
], ArtCredContract.prototype, "setMapRoot", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [PublicKey,
        ...
        Field]),
    __metadata("design:returntype", void 0)
], ArtCredContract.prototype, "issueCredential", null);
export class CredentialProxy {
    constructor(contractAddress, credentialName, owner, proofsEnabled) {
        ...
        this.contractType = ArtCredContract;
        ...
        this.zkApp = new ArtCredContract(this.contractAddress);
    }
    ...
    async getEntityFromObject(obj) {
        return ArtCredEntity.fromPlainObject(obj);
    }
    ...
    async issueCredential(payer, credential, merkleStore) {
        ...
        const entity = ArtCredEntity.fromPlainObject(credential);
