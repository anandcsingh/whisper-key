...
export class RealisticEntity extends Struct({
    id: Field,
    ...
    toPlainObject() {
        return {
            ...
            re: Number(this.re.toBigInt()),
            we: this.we.toString(),
            rt: this.rt.toBase58(),
        };
    }
    static fromPlainObject(obj) {
        return new RealisticEntity({
            id: Field(obj.id),
            ...
            re: Field(obj.re),
            we: CircuitString.fromString(obj.we),
            rt: PublicKey.fromBase58(obj.rt),
        });
    }
    hash() {
        return Poseidon.hash(this.id.toFields()
            ...
            .concat(this.re.toFields())
            .concat(this.we.toFields())
            .concat(this.rt.toFields())
            );
    }
}
export class RealisticContract extends SmartContract {
    constructor() {
        super(...arguments);
        this.mapRoot = State();
    }
...
], RealisticContract.prototype, "mapRoot", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field]),
    __metadata("design:returntype", void 0)
], RealisticContract.prototype, "setMapRoot", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [PublicKey,
        ...
        Field]),
    __metadata("design:returntype", void 0)
], RealisticContract.prototype, "issueCredential", null);
export class CredentialProxy {
    constructor(contractAddress, credentialName, owner, proofsEnabled) {
        ...
        this.contractType = RealisticContract;
        ...
        this.zkApp = new RealisticContract(this.contractAddress);
    }
    ...
    async issueCredential(owner, credential, merkleStore) {
        if (!this.useLocal)
            await fetchAccount({ publicKey: this.contractAddress });
        const entity = RealisticEntity.fromPlainObject(credential);
