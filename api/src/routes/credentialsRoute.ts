...
import { addTask, generateCredentials, getCreatedCredentials, getOwnedCredentials, issueCredentialViaProxy, notifyUser } from '../controllers/credentialsController.js';
...
credsRouter.post('/deployNotification', notifyUser);