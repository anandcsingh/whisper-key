...
import type { EscrowContract } from '../contracts/EscrowContract';
...
const functions = {
    ...
    loadContract: async (args: {}) => {
        const { EscrowContract } = await import('../../../../contracts/EscrowContract.js');
    ...
    depositToSmartContract: async (args: {}) => {
