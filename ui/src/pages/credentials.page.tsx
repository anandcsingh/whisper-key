...
export default function Credentials() {
    const [allCreds, setAllCreds] = useState<CredentialMetadata[]>([]);
          ...
          <section className=" dark:bg-gray-900">
            <div className="grid max-w-screen-2xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
              <div className="mr-auto place-self-center lg:col-span-7">
                <h1 className="max-w-4xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">Existing Verifiable Credentials (VC)</h1>
              </div>              
            </div>
          </section>
          {/* End block */}
                            ...
                            (() => {
                                if (allCreds && allCreds.length > 1) {
                                    return allCreds.map(cred => {
                                        ...
                                        return null; // return null if cred.owner is empty
                                    });
                                }
                                return null; // return null if allCreds is empty or has length <= 1
                            })()
                        }
                    </tbody>
