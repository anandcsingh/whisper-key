        ...
        <section className="place-self-center lg:col-span-7 space-y-8">
            <div className="max-w-screen-xl px-4 py-8 mx-auto sm:px-6 sm:py-12 lg:px-8">
              <header className="text-center">
                <h2 className="text-3xl font-bold sm:text-4xl">Verifiable Credential Stats</h2>
              </header>
                ...
                <div className="stats w-full ">
                  <div className="card w-100 bg-gray-100 shadow-xl mr-5">
                    <div className="card-body">
                      ...
                      <p>Would You like to see more interesting Verifiable Credential stats?</p>
                  ...
                  <div className="stat bg-gray-100" >
                    ...
                    <div className="stat-title">Number of supported credential types</div>
                  ...
                  <div className="stat bg-gray-100">
                    ...
                    <div className="stat-title">Number of credentials issued</div>
                    <div className="stat-value">3005</div>
                    <div className="stat-desc text-secondary">105 credentials issued in the last 24 hrs</div>
                  </div>
                </div>
              </div>
            </div>
